//
//  JBBudgetDetailEditorViewController.m
//  Balance Book
//
...
@implementation JBBudgetDetailEditorViewController
...
- (void)viewWillAppear:(BOOL)animated {
	...
	if ([editingKey isEqualToString:@"budgetAmount"]) {
		editingCell.textField.keyboardType = UIKeyboardTypeNumbersAndPunctuation;
		editingCell.textField.text = [NSString stringWithFormat:@"%1.2f", editingItem.budgetAmount];
	} else {
